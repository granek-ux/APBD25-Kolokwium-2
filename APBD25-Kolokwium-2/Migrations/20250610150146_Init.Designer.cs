...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APBD25_Kolokwium_2.Models.Race", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RaceId = 1,
                            Date = new DateTime(2025, 6, 10, 17, 1, 45, 879, DateTimeKind.Local).AddTicks(2499),
                            Location = "tu",
                            Name = "Name"
                        });
                });

            modelBuilder.Entity("APBD25_Kolokwium_2.Models.RaceParticipation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TrackRaceId = 1,
                            RacerId = 1,
                            FinishTimeInSeconds = 14,
                            Position = 1
                        });
                });

            modelBuilder.Entity("APBD25_Kolokwium_2.Models.Racer", b =>
                {
                    b.Property<int>("RacerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD25_Kolokwium_2.Models.Track", b =>
                {
            ...
            modelBuilder.Entity("APBD25_Kolokwium_2.Models.TrackRace", b =>
                {
                    b.Property<int>("TrackRaceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("APBD25_Kolokwium_2.Models.RaceParticipation", b =>
                {
                    b.HasOne("APBD25_Kolokwium_2.Models.Racer", "Racer")
                        .WithMany("RaceParticipations")
                        .HasForeignKey("RacerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD25_Kolokwium_2.Models.TrackRace", "TrackRace")
                        .WithMany("RaceParticipations")
            ...
            modelBuilder.Entity("APBD25_Kolokwium_2.Models.TrackRace", b =>
                {
                    b.HasOne("APBD25_Kolokwium_2.Models.Race", "Race")
                        .WithMany("TrackRaces")
                        .HasForeignKey("RaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APBD25_Kolokwium_2.Models.Track", "Track")
                        .WithMany("Races")
